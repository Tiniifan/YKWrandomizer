...
namespace YKWrandomizer.Yokai_Watch.Common.Battles
{
    public class BossBattles
    {
        public static Dictionary<int, int> YW1 = new Dictionary<int, int>()
        {
            {unchecked((int)0xB7118CBF), 10 },
            {unchecked((int)0x852A46F0), 15 },
            {unchecked((int)0xB97C0170), 20 },
            {unchecked((int)0x978A29F6), 25 },
            {unchecked((int)0x4833E627), 30 },
            {unchecked((int)0x5F48F264), 35 },
            {unchecked((int)0x5F5AC9B3), 40 },
            {unchecked((int)0x207F6881), 45 },
            {unchecked((int)0x396459C0), 40 },
            {unchecked((int)0x5D089CC4), 55 },
            {unchecked((int)0x21BD02B6), 55 },
            {unchecked((int)0x38A633F7), 60 },
            {unchecked((int)0x77E7A530), 65 },
            {unchecked((int)0x6EFC9471), 70 },
            {unchecked((int)0x45D1C7B2), 75 },
            {unchecked((int)0x5CCAF6F3), 80},
            {unchecked((int)0xDB52EA3C), 85 },
            {unchecked((int)0x25A413C4), 55 },
            {unchecked((int)0x0E894007), 55 },
            {unchecked((int)0xEDFE7305), 99 },
            {unchecked((int)0x74F722BF), 99 },
            {unchecked((int)0x03F01229), 99 },
        };

        public static Dictionary<int, int> YW2 = new Dictionary<int, int>()
        {
            {unchecked((int)0xE14B2B39), 5 },
            {unchecked((int)0xB2C75F37), 15 },
            {unchecked((int)0xFD86C9F0), 20 },
            {unchecked((int)0x579D69FB), 25 },
            {unchecked((int)0x04F07477), 45 },
            {unchecked((int)0x06B6CA2E), 50 },
            {unchecked((int)0x5A8319BC), 20 },
            {unchecked((int)0xDCD96F44), 22 },
            {unchecked((int)0x0F5D6A54), 26 },
            {unchecked((int)0x71AE4A7F), 30 },
            {unchecked((int)0x439828FD), 33 },
            {unchecked((int)0x18DCFF3C), 33 },
            {unchecked((int)0x4E8658BA), 40 },
            {unchecked((int)0x68B57B3E), 35 },
            {unchecked((int)0xC4003432), 50 },
            {unchecked((int)0x33F1ACFF), 60 },
            {unchecked((int)0x3233C6C8), 55 },
            {unchecked((int)0x2B28F789), 95 },
            {unchecked((int)0x191E950B), 69 },
            {unchecked((int)0x0005A44A), 63 },
            {unchecked((int)0x1400E54C), 55 },
            {unchecked((int)0x3F2DB68F), 70 },
            {unchecked((int)0x263687CE), 70 },
            {unchecked((int)0x69771109), 70 },
            {unchecked((int)0x706C2048), 75 },
            {unchecked((int)0x5B41738B), 75 },
            {unchecked((int)0x425A42CA), 75 },
            {unchecked((int)0xC5C25E05), 80 },
            {unchecked((int)0xF6DCFE35), 95 },
            {unchecked((int)0xDDF1ADF6), 95 },
            {unchecked((int)0xC4EA9CB7), 99 },
            {unchecked((int)0xDC33C7C1), 99 },
            {unchecked((int)0x65AB0B79), 90 },
            {unchecked((int)0xEDFE7305), 99 },
            {unchecked((int)0x74F722BF), 99 },
            {unchecked((int)0x03F01229), 99 },
        };
